                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('ced') ? ' has-error' : '' }}">
                            <label for="ced" class="col-md-4 control-label">Número de cédula</label>
                        ...
                        <div class="form-group{{ $errors->has('credit_card') ? ' has-error' : '' }}">
                            <label for="credit_card" class="col-md-4 control-label">Tarjeta de crédito</label>

                            <div class="col-md-6">
                                <input id="credit_card" type="text" class="form-control" name="credit_card" value="{{ old('credit_card') }}" required autofocus maxlength="16">
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            <label for="phone" class="col-md-4 control-label">Número de teléfono</label>
